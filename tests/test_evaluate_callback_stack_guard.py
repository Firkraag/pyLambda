...
class TestEvaluate(TestCase):
    def test_evaluate(self):
        ...
        ast = {"type": "assign", "left": {"type": "var", "value": "a"},
               "right": {"type": "str", "value": "foo"}}
        with self.assertRaises(Exception):
        ...
        # let (x) x;
        ast = {"type": "let", "vars": [{"name": "x", "def": None}], "body": {
            "type": "var", "value": "x"}}
        _Execute(evaluate, [ast, Environment(),
        ...
        with self.assertRaises(Exception):
            _Execute(evaluate, [ast, Environment(), lambda value: value])
        ast = {"type": "if", "cond": {"type": "str", "value": ""},
        ...
        _Execute(evaluate, [ast, Environment(),
                            lambda value: self.assertEqual(value, 2.0)])
        ast = {"type": "if", "cond": {"type": "bool", "value": False},
               "then": {"type": "num", "value": 1}}
        _Execute(evaluate, [ast, Environment(),
                            lambda value: self.assertFalse(value)])
