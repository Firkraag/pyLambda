...
from evaluator_callback_stack_guard import Execute, evaluate
...
class TestEvaluate(TestCase):
    def test_evaluate(self):
        ...
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, 1.0)])
        ast = {"type": "bool", "value": True}
        Execute(evaluate, [ast, Environment(), lambda value: self.assertTrue(value)])
        ast = {"type": "bool", "value": False}
        Execute(evaluate, [ast, Environment(), lambda value: self.assertFalse(value)])
        ast = {"type": "str", "value": "aaa"}
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, "aaa")])
        ast = {"type": "binary", "operator": '+', 'left': {"type": "num", "value": 1},
               "right": {"type": "num", "value": 2}}
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, 3.0)])
        ast = {"type": "prog", "prog": []}
        Execute(evaluate, [ast, Environment(), lambda value: self.assertFalse(value)])
        ...
        with self.assertRaises(Exception):
            Execute(evaluate, [ast, Environment(), lambda value: value])
        ast = {"type": "prog", "prog": [
            {"type": "assign", "left": {"type": "var", "value": "a"}, "right": {"type": "str", "value": "foo"}},
            {"type": "var", "value": "a"}]}
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, "foo")])
        ast = {"type": "assign", "left": {"type": "var", "value": "a"}, "right": {"type": "str", "value": "foo"}}
        with self.assertRaises(Exception):
            Execute(evaluate, [ast, Environment(Environment()), lambda value: value])
        ast = {"type": "call",
        ...
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, "abc")])
        ...
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, 55.0)])
        # let (x) x;
        ...
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, 10.0)])
        ...
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, 2.0)])
        ast = {"type": "if", "cond": {"type": "bool", "value": False}, "then": {"type": "num", "value": 1}}
        Execute(evaluate, [ast, Environment(), lambda value: self.assertFalse(value)])
        ...
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, 8.0)])
        ...
        Execute(evaluate, [ast, Environment(), lambda value: self.assertEqual(value, 6765.0)])
